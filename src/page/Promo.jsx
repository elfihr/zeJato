...
const Promo = () => {
  return (
    <section style={{backgroundImage: `url(${promo})`}} className='py-36 bg-cover bg-center bg-no-repeat bg-fixed flex justify-around text-white items-center max-lg:flex-col max-lg:gap-12 border-slate-700 border-y-2 max-sm:bg-scroll'>
