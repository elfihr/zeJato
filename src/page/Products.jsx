...
const Products = () => {
  return (
    <div style={{backgroundImage: `url(${product})`}} className='bg-cover bg-center bg-no-repeat bg-fixed h-[150vh] py-20 gap-4 flex flex-col items-center text-white border-slate-700 border-y-2 max-sm:bg-scroll max-lx:h-auto'>
