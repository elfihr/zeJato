...
const Hero = () => {
  return (
    <section id='home' style={{backgroundImage: `url(${hero})`}} className='w-full h-screen bg-cover bg-center bg-no-repeat bg-fixed flex items-center'>
        ...
        <p className='text-4xl max-sm:text-2xl'>Serviço Profissional</p>
        ...
        <p className='bg-sky-500 w-64 h-16 flex items-center justify-center text-3xl gap-1 hover:bg-black  duration-300 cursor-pointer'><i class="fa-brands fa-whatsapp"></i> Agende Agora</p>
